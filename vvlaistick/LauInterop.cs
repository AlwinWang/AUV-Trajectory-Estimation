...
namespace vvlaistick
{
    ...
    {
        public static string IP1 = "192.168.1.18";
        public static string Port1 = "90";
        public static string UserName1 = "admin";
        public static string UserPwd1 = "admin";
        public static string Channel1 = "2";
        public static int handle1 = -1;

        public static string IP2 = "192.168.1.20";
        public static string Port2 = "90";
        public static string UserName2 = "admin";
        public static string UserPwd2 = "admin";
        public static string Channel2 = "2";
    ...
    public class LauInterop
    {
        ...
        [DllImport("IPCSDK_CGI.dll")]
        public static extern bool IPCCGI_QueryValue(string sUrl, byte[] sValue, string UserName, string UserPwd, uint Watitime, uint Port = 80);
        #endregion
    }
}
